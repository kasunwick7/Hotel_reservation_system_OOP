...
<body>
 <hr>
	...
	<hr>
	<center>
<h1 style="font-family:verdana; font-size:50; color:#16a085;">Delete Customer Information</h1><br /><br />
	...
	<form action ="csDelete" method="post">
		...
		<h3 style="font-family:verdana; color:#2ecc71; " >Customer ID  </h3>  <input type="text" name="id" value="<%= id %>" readonly ><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >Name  </h3> <input type="text" name="name" value="<%= name %>"><br>
		...
		<h3 style="font-family:verdana; color:#2ecc71; " >User Name </h3> <input type="text" name="username" value="<%= username %>"><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >Password  </h3> <input type="text" name="password" value="<%= password %>"><br>
